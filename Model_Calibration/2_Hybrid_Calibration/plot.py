...
def plot_monthly_consumption(file_0, file_1, file_2):
    ...
    if(len(df_c) > 12):
        df_c = df_c[['Electricity:Facility [J](Monthly)', 'Gas:Facility [J](Monthly) ']].dropna()
        df_c.insert(loc=0, column='Month', value=range(1,13))
...
def main():
    ...
    file_t = 'C:/Users/Han/Documents/GitHub/SDI/Model_Calibration/2_Hybrid_Calibration/target_tweaked.csv'
    file_b = 'C:/Users/Han/Documents/GitHub/SDI/Model_Calibration/2_Hybrid_Calibration/Baseline_V0.0.csv'
    # file_c = 'C:/Users/Han/Documents/GitHub/EP_HL/EnergyPlus/Build/Products/eplusout.csv'
    file_c = 'C:/Users/Han/Documents/GitHub/SDI/Model_Calibration/2_Hybrid_Calibration/simulations/out_tweaked_CBES_model_w_HM/tweaked_CBES_model_w_HM.csv'
